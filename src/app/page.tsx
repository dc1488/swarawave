...
import { Shield, Smartphone, Zap, Settings, ArrowRight, CheckCircle } from "lucide-react"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 animate-slide-in-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" className="bg-[#4A5AFF] hover:bg-[#8692FF] text-white animate-scale-in">
                  Request a Demo
                </Button>
                <Button size="lg" variant="outline" className="border-[#4A5AFF] text-[#4A5AFF] hover:bg-[#4A5AFF] hover:text-white animate-scale-in delay-150">
      ...
      <section className="py-16 bg-[#F7F9FC]">
        <div className="container px-4">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
            {["TechCorp", "FinanceHub", "RetailMax", "TransitPro", "DataFlow"].map((company) => (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow animate-slide-up">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-bold text-[#0D1C3F] mb-3">Secure Proximity Detection</h3>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow animate-slide-up delay-150">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-bold text-[#0D1C3F] mb-3">Device-Agnostic Identity</h3>
                <p className="text-muted-foreground">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow animate-slide-up delay-300">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-bold text-[#0D1C3F] mb-3">Frictionless Engagement</h3>
                <p className="text-muted-foreground">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow animate-slide-up delay-500">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-bold text-[#0D1C3F] mb-3">Enterprise-Grade Controls</h3>
                <p className="text-muted-foreground">
        ...
        <div className="container px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              SwaraWave's ultrasonic infrastructure powers fully offline-ready identity and proximity logic that works across any device equipped with a speaker or microphone. It's built for enterprises that require secure, no-pairing flows, low operational overhead, and flexible integration into existing apps, wallets, and platforms.
            </p>
      ...
      <section className="py-20">
        <div className="container px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-8">
                <h3 className="text-2xl font-bold text-[#0D1C3F] mb-4">Retail & FMCG</h3>
                <p className="text-muted-foreground mb-6">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-8">
                <h3 className="text-2xl font-bold text-[#0D1C3F] mb-4">Mobility & Transport</h3>
                <p className="text-muted-foreground mb-6">
